...
def generate_prompt(foa, current_datestr):
    ...
    At the end of each answer, please make sure to enclose the information pertaining to the exact section where the answered was retrieved in square brackets and add the word Reference:.    
...
if __name__ == "__main__":
    foa_name, final_report = run_pipeline(url_list)
